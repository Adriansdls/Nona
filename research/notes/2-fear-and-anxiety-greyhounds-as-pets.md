---
title: 2. Fear and Anxiety  | Greyhounds as Pets
id: 2-fear-and-anxiety-greyhounds-as-pets
tags:
- lost-dog-behavioral
- greyhound
- sighthound
...
deprecated: false
summary: 'Greyhounds as Pets NZ practitioner guide on greyhound fear and anxiety,
  highly relevant to lost-dog behavioral modeling. Documents greyhound-specific stress
  responses using 4F framework (Fidget/Freeze/Flight/Fight). Key lost-dog insights:
  (1) FREEZE response is characteristic in greyhounds — ''frozen or stiff posture,
  pupils dilated, trembling, tense closed mouth, ears back, tail tucked, body hunched,
  all feet stuck to floor, leaning backwards'' — this explains why a lost greyhound
  may be visible but unresponsive. (2) FLIGHT response details: ''ears back, tail
  tucked, actively trying to escape — slinking away or running'' — greyhounds in flight
  will not respond to direct approach. (3) Most greyhounds are under-socialized to
  urban environments (grown up rural, no exposure to traffic, stairs, glass doors,
  different dogs/people). (4) Tactical advice: approach from oblique angle not direct,
  crouch/sit, avoid eye contact, turn body away. Food often ineffective when dog is
  in fear state. (5) Muzzle and martingale collar mandatory off-property — collar
  slippage is a key escape vector.'
---

*Suggested by [[lost-dog-resources-greyhound-pets-inc]] — Greyhounds as Pets NZ fear and anxiety page - documents greyhound-specific fear response relevant to lost dog avoidance behavior*

2. Fear and Anxiety  | Greyhounds as Pets
Skip to main content
Back to Training
While many greyhounds settle easily into their new home as if they were born for pet life, for others it can be an overwhelming and traumatic transition, at least initially.
...
Fidget/Fool around:
this is a way for the dog to relieve stress when they aren’t sure what to do, a bit like making a joke in an uncomfortable situation or chewing your nails when nervous.
...
Freeze:
greyhounds are known for displaying the freeze response and is a bit like playing possum, thinking “maybe if I stay still the scary thing will go away”
...
Flight:
this is attempting to get further away from the threat to hide or avoid it
...
Fight:
this is aggressively confronting the threat, typically as a last resort
