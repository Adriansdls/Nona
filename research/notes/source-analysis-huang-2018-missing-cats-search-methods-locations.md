---
title: Source Analysis — Huang 2018 Missing Cats (Search Methods & Locations)
id: source-analysis-huang-2018-missing-cats-search-methods-locations
tags:
- lost-dog-behavioral
- source-analysis
...
summary: 'Huang et al. 2018 (Animals; PMC5789300): peer-reviewed retrospective case
  series, n=1,210 missing cats, online questionnaire. Primary quantitative anchor
  for temporal recovery decay: 34% found alive by day 7, 50% by day 30, 56% by day
  61, then plateau — establishing day 60 as the practical ceiling for active recovery
  probability. 75% of cats found within 500m of escape point; displacement radius
  bifurcates sharply by outdoor-access history (indoor-only 75th-pct 137m vs. indoor-outdoor
  1,609m, p≤0.001). Physical search within first week is primary recommended intervention.
  Directly relevant to the Nona probabilistic behavioral engine as the closest empirical
  analog for temporal phase thresholds and displacement priors, pending dog-species
  calibration.'
---
