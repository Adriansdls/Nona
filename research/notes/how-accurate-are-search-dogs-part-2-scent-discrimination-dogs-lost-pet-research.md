---
title: 'How Accurate are Search Dogs? – Part 2: Scent Discrimination Dogs - Lost Pet
  Research and Recovery'
id: how-accurate-are-search-dogs-part-2-scent-discrimination-dogs-lost-pet-research
tags:
- lost-dog-search-ops
- search-dogs
- lost-dog
...
deprecated: false
summary: 'Lost Pet Research & Recovery Part 2 of search dog accuracy series, covering
  scent discrimination dogs (trailing, tracking, and scent lineup dogs). Key taxonomy:
  trailing dogs follow scent trail (may not be where subject walked), tracking dogs
  follow exact footsteps via crushed vegetation + scent, scent-specific area dogs
  search within handler-defined zone only. Key statistics: bloodhound trailing — novice
  dogs (< 18 months training) had 53.3% find rate; veteran dogs (> 18 months + law
  enforcement experience) had 96% find rate on 0.5–1.5 mile trails aged 48 hours.
  Scent lineup accuracy: police dogs 80% accuracy after 9 months training (Settle
  1994); French judicial dogs (German Shepherds) showed 85% sensitivity and 100% specificity
  after 18-month intensive program. Wildlife scat matching: 87–98% accuracy across
  studies. Critical multi-dog protocol: in French judicial program, scent matches
  confirmed by 2–7 dogs; results from a single dog are not reliable. Practical implication:
  experienced trailing dogs are highly accurate for aged trails; novice dogs are not
  reliable — the experience level of the handler/dog team is the dominant variable.'
---

*Suggested by [[how-accurate-are-search-dogs-part-1-area-detection-dogs-lost-pet-research-and-re]] — Part 2 of search dog accuracy series — covers scent discrimination dogs (tracking/trailing), directly relevant to lost dog recovery*

How Accurate are Search Dogs? – Part 2: Scent Discrimination Dogs - Lost Pet Research and Recovery
Skip to content
This is the second part of a series on the accuracy of search dogs.  Part 1 looked at
Area Detection Dogs
.
Types of Scent Discrimination Dogs
A scent discrimination dog is trained to follow and/or identify the scent of an individual person or animal.  These dogs are described as scent-specific.  In most cases the search dog handler first provides the dog with a scent article containing the the scent of a specific person or animal.  Scent-discrimination dogs may work in one of several ways.
Trailing Dogs
...
Tracking Dogs
Many people use the terms tracking dog and trailing dog interchangeably, but there is technically a difference.  A tracking dog will focus on crushed vegetation and ground disturbance along with deposited scent in order to follow in the exact footsteps of the suspect or missing person.  Some tracking dogs are not scent-specific and just follow human scent and ground disturbance.  Tracking dogs may be used by the police, but most tracking is recreational such as
AKC Tracking
.
Scent-Specific Area Search Dogs
...
Scent Matching or Scent Lineup
...
Scent Discrimination Dog Research Studies
The lack of scientific research on scent discrimination dogs is really surprising given that search dog evidence is admissible in court in many locations (Brisbin 2000).  Most scent discrimination experiments focus on scent matching or lineups rather than trailing.  Studies of scent discrimination dog accuracy may measure one or more factors:
Sensitivity: this measures how often the dog detected the target scent when it was present.  A dog with poor sensitivity will miss more correct matches.  They might also fail to find a scent trail when one is present or lose a scent trail they were following.
Specificity: this measures how often the dog correctly identified or matched the scent article to the target(s).  A dog with lower specificity with have more frequent false alerts.  They might follow the wrong trail or alert on the wrong person.
Human Scent Lineup Studies
...
As an interesting side note, Marchal et al. (2016) found that (9) German Shepherds outperformed (4) Belgian Shepherds (Malinois).  The German Shepherds showed higher sensitivity and zero false alerts.  They suggest that the Belgian Shepherds exhibited a decreased level of attention in completing the scent lineups.
Wildlife Scat Matching Studies
...
Note: a 100% indicates that all dogs performed better than chance and NOT that they were all successful.
...
Woidtke et al. (2018) conducted the most recent test on the accuracy of mantrailing (i.e. scent-specific trailing of a human subject).  Their study used 7 dogs from different breeds including 3 bloodhounds and one bloodhound mix.  Four dogs were mantrailing police dogs and 3 dogs were private search and rescue dogs.  The dogs had between 1.2-5 years of training/experience (mean = 3.4 years), and all were certified by their organizations.  All trails were set in urban locations with a T-junction at the end of the trail (i.e. split trail).  Trails were only 130 meters long and tests were conducted within 5 minutes of trails being set.  The dogs were marked as successful if they followed the correct scent trail or gave a proper “negative indication,” and they were marked as wrong if they followed the wrong trail (false positive) or could not find the trail (false negative).
This study found the following results:
The success rate of the police dogs was significantly much better than the private search and rescue dogs (p=0.00001).
Some dogs performed significantly better than other dogs on each test.
The dogs were significantly more successful with (damp) saliva scent-articles than axillary (armpit) sweat (p=0.009965).
...
They were all trained using a consistent method (Armin Schweda) for 2 1/2 years starting when they were puppies.
They had several years of experience and received regular, weekly training.
The handlers had many years of experience as police dog handlers.
Three out of the 4 police dogs were bloodhounds.  This breed showed higher success rates overall.
Conclusions on Scent Discrimination Dog Accuracy
...
Scent Discrimination Dog Success in Real-World Cases
...
Brisbin, I.L., S. Austad, and S.K. Jacobson.  2000.  Canine Detectives: the Nose Knows – Or Does It?
Science 290
: 1093.
Harvey L.M., S.J. Harvey, M. Hom, A. Perna, and J. Salib. 2006.
The Use of Bloodhounds in Determining the Impact of Genetics and the Environment on the Expression of Human Odortype
.
Journal of Forensic Science 51(5): 1109-1114.
Harvey L.M. and J.W. Harvey.  2003.  Reliability of Bloodhounds in Criminal Investigations.
Journal of Forensic Science 48(4): 5 pages.
Jones, P.  2006.
Scents and Sense-Ability
.
Forensic Magazine
April/May 2006.
Kerley, L.L. and G.P. Salkina.  2007.  Using Scent-Matching Dogs to Identify Individual Amur Tigers from Scats.
Journal of Wildlife Management 71(4):
1349-1356.
Marchal, S., O. Bregeras, D. Puaux, R. Gervais, and B. Ferry.  2016.
Rigorous Training of Dogs Leads to High Accuracy in Human Scent Matching-To-Sample Performance
.  PLoS ONE 11(2): e0146963.doi:10.1371/journal.pone.0146963.
Settle, R.H., B.A. Somerville, J. McCormick, and D.M. Broom.  1994.  Human Scent Matching Using Specially Trained Dogs.
Animal Behavior 48(6)
: 1443-1448.
Schoon, G.A.A.  2001.
Scent Identification Line-Ups Using Trained Dogs in the Netherlands
.
Problems of Forensic Science 47:
175-183.
Schoon. G.A.A. 1998.  A First Assessment of the Reliability of an Improved Scent Identification Line-Up.
Journal of Forensic Science 43(1)
: 70-75.
Stockham, R.A., D.L. Slavin, and W. Kift.  2004a.
Specialized Use of Human Scent in Criminal Investigations
.
Forensic Science Communications 6(3)
: 13 pages.
Stockham, R.A., D.L. Slavin, and W. Kift.  2004b.
Survivability of Human Scent
.
Forensic Science Communications 6(4)
.
Taslitz, A.E.  1990.
Does the Cold Nose Know? The Unscientific Myth of the Scent Dog Lineup.
Hastings Law Journal 42:
15-134.
Wasser, S.K., H. Smith, L. Madden.  N. Marks, and C. Wynne.  2009.
Scent Matching Dogs Determine Number of Unique Individuals From Scat
.
Journal of Wildlife Management 73(7):
1233-1240.
Woidtke L, J. BreBler, and C. Babian.  2018.
Individual Human Scent as a Forensic Identifier Using Mantrailing
.  Forensic Science International 282: 111-121.
Related Posts
3 thoughts on “How Accurate are Search Dogs? – Part 2: Scent Discrimination Dogs”
Excellent article. Thanks so much for your research.
Reply
Pingback:
How To Cover The Scent Of A Dog In Heat? – BabyDogAsk
Pingback:
How To Get Dog Scent Out Of House? – BabyDogAsk
Leave a Comment
Cancel Reply
