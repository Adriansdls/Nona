---
title: Dog genetics suggest that behavior is more than just breed | Broad Institute
id: dog-genetics-suggest-that-behavior-is-more-than-just-breed-broad-institute
tags:
- lost-dog-behavioral
- breed-genetics
- gwas-study
...
deprecated: false
summary: 'Broad Institute primary press release for Morrill K et al. 2022 (Science,
  DOI: 10.1126/science.abk0639). Study of 2,155 genomes + 18,385 owner surveys from
  Darwin''s Ark (78 breeds). GWAS identified 11 genetic loci strongly associated with
  behavior — none breed-specific — plus 136 suggestively associated loci. Breed contributes
  only 9% to behavioral variance. Physical traits are 5x more likely to be breed-predicted
  than behavioral traits. Age is a better predictor of toy-directed motor patterns
  than breed; sex best predicts leg-lifting behavior. Biddability (responsiveness
  to human direction) is more heritable and breed-correlated than agonistic threshold
  (ease of provocation), which shows breed is almost useless for fear/reactivity prediction.
  In Labrador retrievers — breed with lowest propensity to howl — 8% of owners still
  report occasional howling. Even 10% of greyhound owners report occasional toy-burying.
  Behavioral traits predate modern canine breeding by thousands of years; heritable
  variation was already present in ancient dogs before selective breeding standardized
  physical traits. Key implication: DNA breed-ancestry tests cannot reliably predict
  individual personality. Darwin''s Ark is open-source database enabling this research.'
---

*Suggested by [[breed-is-not-a-good-predictor-of-individual-dog-behavior-study-finds]] — Broad Institute press release on Morrill 2022 dog genomics - additional methodological detail*

Dog genetics suggest that behavior is more than just breed | Broad Institute
Skip to main content
Dog genetics suggest that behavior is more than just breed
A study of purebred and mixed-breed dogs shows that distinctive physical traits are not highly correlated to inheritable behavior traits.
By Jim Fessenden, UMass Chan Medical School Communications
April 28, 2022
...
The study of 2,155 dog genomes and 18,385 owner surveys, published in
Science
, identifies 11 unique genetic regions (or loci) in the dog genome that are strongly associated with behavior. None of these regions were specifically associated with any particular breed, suggesting that these personality traits predate modern canine breeding by humans.
...
"While genetics plays a role in the personality of any individual dog, the specific dog breed is not a good predictor of those traits," said study senior author
Elinor Karlsson
, who is an associate professor of molecular medicine at UMass Chan Medical School and director of the
Vertebrate Genomics Group
at Broad. "A dog’s personality and behavior are shaped by many genes as well as their life experiences. This makes them difficult traits to select for through breeding.
...
To explore the complicated relationship between modern dog breeds and behavioral characteristics, Karlsson; the study's lead author, graduate student Kathleen Morrill; and their colleagues applied a strategy called a
genome-wide association study (GWAS)
to connect areas of the canine genome with certain traits or characteristics. For their data, they turned to
Darwin's Ark
, an open-source database of owner-reported canine traits and behaviors.
...
Adapted from a
press release
issued by UMass Chan Medical School.
Paper(s) cited
Morrill K,  et al.
Ancestry-inclusive dog genomics challenges popular breed stereotypes
.
Science
. Online April 28, 2022. DOI: 10.1126/science.abk0639.
Tags:
Vertebrate biology
Related People
Elinor Karlsson
...
Looking across species for the genetics underlying obsessive-compulsive disorder
Learn more about
Infographic: What is GWAS?
Related
News 04.27.2023
...
Read more
Blog 08.20.2019
Bioethics discussions grow at the Broad
Read more
Profile 03.01.2018
Elinor Karlsson draws disease insights from dog descent
Read more
