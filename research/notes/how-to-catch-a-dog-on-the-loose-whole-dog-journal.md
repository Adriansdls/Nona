---
title: How to Catch a Dog on the Loose - Whole Dog Journal
id: how-to-catch-a-dog-on-the-loose-whole-dog-journal
tags:
- lost-dog-behavioral
- calming-signals
- owner-behavior-errors
- approach-technique
...
deprecated: false
summary: 'Whole Dog Journal (Denise Flaim) draws heavily on pet detective Kat Albrecht
  (founder, Missing Pet Partnership, Federal Way WA) and Bonnie Folz (Howard Beach
  NY, Vivi-the-Whippet case). Central argument: catching a panicked dog is an art
  requiring suppression of instinctive human behaviors (chasing, calling, grabbing)
  and deliberate adoption of canine calming signals. Three core DON''Ts: (1) DON''T
  Grab — sudden grabs trigger bites; woman bitten in ear attempting pit bull rescue.
  (2) DON''T Chase — biological programming conflict; chasing causes dog to run faster,
  often into traffic; for highway situations, use flashers, follow from vehicle, call
  highway patrol rather than jumping out. (3) DON''T Talk — when dogs are flooded
  with adrenaline they make fear-associations; the first person who calls/whistles/pats
  their leg may condition the dog to bolt from EXACTLY those cues in future, even
  from their owner — adrenaline prevents processing of identity. Three core DOs: (1)
  DO Use Calming Signals — from Turid Rugaas ''On Talking Terms with Dogs: Calming
  Signals'' (2005): yawning, blinking, peripheral-vision gaze (never direct stare),
  oblique approach (from side, never head-on); direct approach mimics predator. (2)
  DO Go ''Low and Slow'' — get to dog''s level, extreme patience; one case: 3 hours
  motionless in field before dog approached. (3) Albrecht''s food technique: crinkly
  potato-chip bag filled with hot dogs, pretend to eat off the ground, say ''Nummy
  nummy'' and make lip-smacking sounds, drop morsels, watch only from peripheral vision
  — ''It could take 45 minutes to an hour, or longer.'' Once close enough, some dogs
  catch owner scent and have immediate recognition response: whining and tail-wagging.
  Practical recovery tools: neon car-window markers (Neon Car Glass Markers, ½-inch
  broad-tip), neon poster flyers with 5 key words in large type + photo + clear plastic
  protector, robocall services (FindToto.com), coordinate search teams via helpinglostpets.com.'
---
...
the 2005 book by Norwegian dog trainer Turid Rugaas, popularized the concept of mimicking the body language that dogs use to communicate peaceful intentions, avoid conflict, and defuse tension.
...
{title}
Manage Consent
This website uses cookies and other tracking technologies to offer you a better experience, personalize content and ads, and analyze our site traffic. Before proceeding, you agree to our
Terms
