---
title: 'SPARCS 2015: “Reducing Stress of Dogs in Shelters” with Michael Hennessy,
  PhD - The Modern Dog Trainer'
id: sparcs-2015-reducing-stress-of-dogs-in-shelters-with-michael-hennessy-phd-the-mo
tags:
- lost-dog-behavioral
- cortisol
- hpa-axis
...
deprecated: false
summary: 'Summary notes from Hennessy''s SPARCS 2015 talk on shelter dog stress. Key
  data: cortisol is ~3x higher in shelter dogs than pet dogs at home on Day 1. Cortisol
  elevated days 1-3, intermediate days 4-9, then adapts/plateaus. White blood cells
  continue to rise. Psychological stressors (novelty, separation, uncertainty, threat)
  primarily activate the HPA system. As little as 15 minutes of human interaction
  reduces cortisol response. Stray dogs show greater stress susceptibility than relinquished
  dogs. Confirms the three-phase physiological stress arc: acute (days 1-3), intermediate
  (days 4-9), adaptation (day 9+). Relevant to lost-dog behavioral phase-transition
  physiology.'
---

SPARCS 2015: “Reducing Stress of Dogs in Shelters” with Michael Hennessy, PhD - The Modern Dog Trainer
team@themoderndogtrainer.com
Facebook
Twitter
Google
Instagram
...
White blood cells are elevated on 1
st
day in shelter and continue to rise.
