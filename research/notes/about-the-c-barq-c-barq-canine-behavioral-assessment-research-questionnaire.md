---
title: 'About the C-BARQ - C-BARQ: Canine Behavioral Assessment & Research Questionnaire'
id: about-the-c-barq-c-barq-canine-behavioral-assessment-research-questionnaire
tags:
- lost-dog-behavioral
- c-barq
...
deprecated: false
summary: 'Official description of C-BARQ (Canine Behavioral Assessment & Research
  Questionnaire), developed by Hsu and Serpell (2003), University of Pennsylvania.
  Now contains evaluations for ~50,000 dogs across 300+ breeds. Primary instrument
  for standardized canine behavioral phenotyping used in research and rescue contexts.
  Measures 14 behavioral factors: stranger-directed aggression, owner-directed aggression,
  dog-directed aggression, dog rivalry, stranger-directed fear, nonsocial fear, dog-directed
  fear, separation-related behavior, attachment/attention-seeking, trainability, chasing,
  excitability, touch sensitivity, energy level. Mini C-BARQ (Duffy, Kruger & Serpell,
  2015) is designed for shelter intake screening. C-BARQ database includes 35,000+
  working assistance dog evaluations. Used in 70+ published studies since 2004. Key
  application for rescue platforms: mini C-BARQ at intake provides objective behavioral
  screening superior to breed-based assumptions; predicts training success in guide
  dog programs; identifies behavioral risks for adoption placement. Individual dog
  C-BARQ score is compared to population averages from thousands of dogs — this is
  the correct architecture for individual temperament assessment over breed priors.'
---

*Suggested by [[case-distribution-sources-and-breeds-of-dogs-presenting-to-a-veterinary-behavior]] — C-BARQ is the primary validated behavioral assessment instrument used in Duffy et al 2008 breed aggression study and the van Rooy 2014 behavioral genetics review*
...
View articles citing the C-BARQ
What does the C-BARQ measure?
How can my group benefit from the C-BARQ?
...
view a list of published studies
). Many of these important projects would not have been possible without the existence of a reliable, validated instrument for evaluating behavior in dogs, such as the C-BARQ. Existing C-BARQ data are also available to researchers interested in undertaking collaborative work with the Center for the Interactions of Animals and Society (CIAS). For more information about this, please contact Dr. James Serpell (
serpell@vet.upenn.edu
) directly.
1
Guide Dogs for the Blind (CA), The Seeing Eye (NJ), Guiding Eyes for the Blind (NY), Leader Dogs for the Blind (MI), and Canine Companions for Independence (CA).
