---
title: Source Analysis — Effects of Lure Type on Chase Behaviour in Greyhounds
id: source-analysis-effects-of-lure-type-on-chase-behaviour-in-greyhounds
tags:
- lost-dog-behavioral
- source-analysis
...
summary: 'Starling, Wilson & McGreevy (2020) PMC7760772. N=89+537 greyhounds. Sighthounds
  fixated on lure last-known-location 8.34x more when lure stopped and went silent
  (straight track) vs. audible/moving racetrack lure (OR=8.34, 95% CI 1.72-42.38,
  p=0.009). Load-bearing for galgo displacement prediction: when rabbit stimulus disappears
  in Algarve scrubland, galgo fixes on prey-loss terminus (not departure point), sound
  likely more salient than visual for chase initiation, and chase motivation is self-reinforcing
  appetitive behavior that persists without prey capture.'
---
