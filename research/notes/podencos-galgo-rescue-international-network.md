---
title: Podencos — Galgo Rescue International Network
id: podencos-galgo-rescue-international-network
tags:
- lost-dog-behavioral
- podenco
...
deprecated: false
summary: 'GRIN podenco profile with galgo comparison. Podenco behavioral profile vs
  galgo: both are smart, loyal, gentle; podencos are ''smart and eager to please,
  but sometimes stubborn'' and have ''amazing ability to jump'' — require secure fence.
  Podencos have wider prey range (bred for small game including rabbits, up to wild
  boar) vs galgo''s hare focus. Podenco trauma context mirrors galgo: kept on short
  chains, starved, dark sheds, abandoned or killed post-season. Key behavioral difference
  for lost dog context: podenco uses multi-sensory hunting (smell + sight) vs galgo''s
  pure sight/speed focus — different tracking and prey-chase profile. Podenco abandonment
  method: ''driven to a remote location and abandoned'' more than galgo-style hanging
  — implies different initial displacement scenario.'
---

*Suggested by [[galgos-galgo-rescue-international-network]] — GRIN podencos page — comparison from org that handles both breeds*
...
Galgo Rescue International Network
| 17784 North County Road 15, Wellington, CO 80549
instagram-unauth
facebook-unauth