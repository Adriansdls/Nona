---
title: "Behavioural characteristics of sighthounds: an exploratory investigation\n\
  \t\t\t\t\t\t\t| Dog behavior"
id: behavioural-characteristics-of-sighthounds-an-exploratory-investigation-dog-beha
tags:
- lost-dog-behavioral
- sighthound
- breed-behavior
...
deprecated: false
summary: '2025 peer-reviewed study (Dog Behavior journal, vol 11 no 1) on behavioral
  variation across 10 sighthound breeds plus Lurchers, using C-BARQ sections, n=768.
  Key findings: sighthounds show very low aggression across all breeds; high predatory
  drive (chasing cats/birds differs by breed, Saluki highest, Piccolo Levriero Italiano
  lowest, p<0.001); fair attachment/affection (Piccolo Levriero Italiano and Irish
  Wolfhound show most owner-shadowing and interaction-soliciting, p<0.001). Authors
  note breed/functional type role in behavior is controversial, with effect sizes
  ranging from negligible to substantial across the literature. Companion paper by
  same lab (Normando et al. 2024, vol 10 no 1) examined prevalence of behavioral problems
  in galgos vs. other rescue dogs.'
---
...
Università degli Studi di Padova
DOI:
https://doi.org/10.4454/db.v11i1.207
Published
                                2025-12-19
Keywords
dog
