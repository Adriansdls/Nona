---
title: Source Analysis — Kremer 2021 (RTO Spatial Analysis, Dallas n=30,609)
id: source-analysis-kremer-2021-rto-spatial-analysis-dallas-n30609
tags:
- lost-dog-behavioral
- source-analysis
...
summary: 'Kremer 2021 (Frontiers Vet Sci) peer-reviewed spatial analysis of n=30,609
  Dallas dogs: 70% of RTOed strays found within 1 mile of home, 42% within 400 ft
  (one city block). Microchipped healthy adult strays have 71% RTO rate vs. 39% without
  chip (χ²=1,101, p<0.001, n=13,794). 91% of Shelter RTOs reclaimed within the 5-day
  hold period; post-hold median LOS = 0. Geographic stratification: northern/lower-density
  areas show 1.5–2.5 mile median distances vs. 0–0.5 miles in southern high-density
  areas — directly encodable as density-adjusted distance priors for Nona''s behavioral
  scoring engine. Key gap: no temporal dimension (time-since-escape vs. distance)
  and no breed/size distance breakdown.'
---
