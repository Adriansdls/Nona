---
title: Source Analysis — Morrill et al. 2022 (Ancestry-inclusive dog genomics)
id: source-analysis-morrill-et-al-2022-ancestry-inclusive-dog-genomics
tags:
- lost-dog-behavioral
- source-analysis
...
summary: 'Morrill et al. 2022 (Science, Darwin''s Ark, N=18,385 dogs) shows breed
  explains just 9% of individual behavioral variation. Crucially for the research
  query: agonistic threshold — the fear/reactivity factor most relevant to lost-dog
  evasion behavior — is the least breed-predictable behavioral factor; breed is ''almost
  uninformative'' for it. Physical traits are 5x more heritable and breed-differentiated
  than behavioral traits. GWAS loci for behavior are NOT unusually differentiated
  across breeds (contrast: aesthetic loci ARE), confirming behavioral tendencies predate
  breed formation. Implication: breed classification should carry minimal weight in
  any probabilistic evasion/approach scoring for lost dogs; individual behavioral
  priors must dominate.'
---
