---
title: What You Don't Know About Lost Pets Can Hurt Them
id: what-you-dont-know-about-lost-pets-can-hurt-them
tags:
- lost-dog-behavioral
- marn
- kat-albrecht
...
deprecated: false
summary: 'Kat Albrecht-Thiessen (MARN / Maddie''s Fund, May 2021) — authoritative
  practitioner guide from former police K9 detective who founded Missing Animal Response
  Network. Five key principles: (1) search home base first — dogs can be trapped on
  own property without barking; (2) recruit volunteers; (3) seek professional lost-pet
  recovery specialists; (4) social media (Lost & Found Facebook pages); (5) neon poster
  boards (not small white flyers) — proven to capture driver attention. Three temperament
  typologies for lost dogs: Gregarious (wiggly-friendly, self-adoption risk near escape
  point), Aloof (wary, eventually accepts contact when hungry; often recovered weeks/months
  later — appearance of stray), Skittish (genetics/socialization failures; travel
  farther, higher car-strike risk; people assume ''abuse'' so don''t search for owner).
  Lost dog calming signals protocol: crinkly bag with moist hotdogs, avoid eye contact,
  kneel/drop food, ''nummy nummy'' sounds, optionally lie flat + whining sounds. Critical:
  olfactory portion of dog''s brain shuts down during fight-or-flight — panicked dog
  will not recognize owner''s scent. Reward ads cause two problems: scamming and chasing
  (rescuers rush to sighting and scatter dog, sometimes into traffic). Social media
  sighting locations should be kept private and released only to trained searchers.
  2017 Missing Cat Study: 40% of lost cats found by physical search; median distance
  outdoor-access cats: 17-house radius; escaped indoor cats: 2-house radius. ''House
  as trap'' technique for shy dogs that return but won''t let owner approach. MARN''s
  National Pet Detective Directory referenced for professional help.'
---
...
Most critically,
these cats will not meow
. Meowing would give up their location to a predator. Their behavior has nothing to do with whether the cat loves you, recognizes your voice, or whether s/he can smell you. It has everything to do with the fact that
a panicked cat will hide in silence
. So just because you do not see or hear your cat does not mean that s/he is not very close to home.
...
To watch a video explanation and demonstration of how to use Calming Signals check out
this blog post
.
...
Rewards
Rewards can be problematic. While in some cases they help encourage people to return a lost pet, rewards frequently create two problems: scamming and chasing. Scamming occurs when a thief finds your advertisement and decides they are going to falsely claim they have your pet (when they do not) and ask for you to wire them money. Offering a reward for a lost cat is less problematic since there isn't the same problem of people rushing to lost cat sightings. There is actually cool brain research regarding offering a "reward" verses asking for "help" on
this blog post
.
...
www.craigslist.com
and Canada's version which is
www.kijji.ca
. Websites like Nextdoor and Facebook groups that are set up for specific neighborhoods are also great locations to post information and reach people who live near the escape point.
...
For more information on lost pet behaviors as well as MARN's lost pet recovery training courses, visit their website at
