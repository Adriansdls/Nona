---
title: '[2104.02060] Toward Generating Synthetic CT Volumes using a 3D-Conditional
  Generative Adversarial Network'
id: 210402060-toward-generating-synthetic-ct-volumes-using-a-3d-conditional-generati
tags:
- lost-dog-behavioral
...
,
Phuong Nguyen
View a PDF of the paper titled Toward Generating Synthetic CT Volumes using a 3D-Conditional Generative Adversarial Network, by Jayalakshmi Mangalagiri and 9 other authors
View PDF
Abstract:
...
[eess.IV]
for this version)
https://doi.org/10.48550/arXiv.2104.02060
Focus to learn more
arXiv-issued DOI via DataCite
Submission history
From: Jayalakshmi Mangalagiri [
view email
]
[v1]
Fri, 2 Apr 2021 12:25:37 UTC (610 KB)
Full-text links:
Access Paper:
View a PDF of the paper titled Toward Generating Synthetic CT Volumes using a 3D-Conditional Generative Adversarial Network, by Jayalakshmi Mangalagiri and 9 other authors
View PDF
