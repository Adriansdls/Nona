---
title: Lost Dog Behavior | Pet FBI Pets Found By Internet
id: lost-dog-behavior-pet-fbi-pets-found-by-internet
tags:
...
deprecated: false
summary: 'Pet FBI lost-dog behavior guide (based on Kat Albrecht MAR material). Specific
  distance estimates: elderly/disabled/small dogs typically within 1-2 mile radius;
  friendly/purebred dogs also 1-2 miles but quickly picked up by strangers; aggressive/panicked/skittish
  dogs can travel miles and require 5-10 mile poster radius. Three approach zones
  for panicked dogs: Awareness Zone, Alert Zone (body language changes), Action Zone
  (fight or flight). Key: approaching dog straight-on mimics predator stalking — must
  shuffle sideways, hip facing dog. People who find loose dogs frequently transport
  them out of search area creating a critical displacement problem. Cell phone sighting
  coordination is highly effective real-time recovery tool.'
---
...
Author's Website:
https://petfbi.org
Published: 1/25/2014, 7:05:36 PM
Last Updated: 12/13/2024, 7:40:57 PM
Thanks to Kat Albrecht and the Missing Animal Response Network for permission to use the following excellent material from her book, “Pet Tracker: The Amazing Story of Rachel the K9 Pet Detective” and her web site
...
How to Use the Report Matching Dashboard
2026-03-28 by petfbi@petfbi.org
Learn how to use Pet FBI's automatic report matching dashboard to instantly find lost and found pet reports that match yours by location, date, and animal type.
...
9 Steps to Finding a Pet
Lost Dog Behavior
Tips for Posting Flyers
Flyer Template
Whom to Contact
