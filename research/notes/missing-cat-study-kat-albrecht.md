---
title: Missing Cat Study - Kat Albrecht
id: missing-cat-study-kat-albrecht
tags:
- lost-dog-behavioral
- missing-cat-study
- proximity
...
deprecated: false
summary: 'Kat Albrecht''s page summarizing why the Missing Cat Study was developed
  and its results. 2013 MPP internal data: 84% of 128 lost outdoor-access cats found
  within 5-house radius; 92% of 158 displaced indoor-only cats also found within 5-house
  radius. Formal study subsequently conducted in collaboration with Emeritus Professor
  Jacquie Rand (University of Queensland, 2017), published as Huang et al. 2018 in
  Animals — confirmed Albrecht''s earlier findings. Primary search methodology: slow,
  methodical, nearby search of neighbor yards. Albrecht explicitly states goal is
  to run analogous ''Missing Dog Study'' to determine distance distributions for lost
  dogs — as of the page''s writing, no such study has been published. Note: this page
  is about cats, not dogs, but its methodological and proximity findings are reference
  points for the analogous (but not yet studied) dog case. Cited reference: Huang
  B, Albrecht K, Rand J, et al. (2018). Lost cats in Australia: a representative sample.'
---

Missing Cat Study - Kat Albrecht
